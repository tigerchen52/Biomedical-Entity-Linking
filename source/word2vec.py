...
w2v_train = '../output/pubmed_co_graph.txt'
w2v_output = '../output/embed/entity_emb_50.txt'
w2v_window = 10
w2v_size = 50
w2v_sample = 1e-3
w2v_hs = 0
...
def cal_sim_valid(path):
    ...
    with open('../output/embed/embed_valid.txt', 'w', encoding='utf8') as f:
        f.write(line)


if __name__ == "__main__":
    #cal_sim_valid(path='../output/embed/entity_emb_50.txt')
    synonym_detect()